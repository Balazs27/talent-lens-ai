...
/* ── Animated product demo shown on the left panel ── */
const SKILLS = [
...
function ProductDemo() {
  ...
  useEffect(() => {
    ...
    // Score section appears after all skills
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-8 max-w-sm w-full">
          ...
          >
            <p className="text-2xl font-bold text-white leading-snug tracking-tight">
              Discover the best role<br />for your skills.
            </p>
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="mt-1.5 text-sm text-slate-500">
              Join Internal Talent Matching MVP — it&apos;s free to get started.
            </p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative flex rounded-xl bg-slate-100 border border-slate-200 p-1 gap-1">
                {/* Sliding indicator */}
                <motion.div
                  className="absolute top-1 bottom-1 rounded-lg bg-white shadow-sm border border-slate-200"
                  animate={{ left: role === "employee" ? "4px" : "calc(50% + 2px)", right: role === "employee" ? "calc(50% + 2px)" : "4px" }}
                ...
                <button
                  ...
                  className={`relative z-10 flex-1 py-2 text-sm font-semibold rounded-lg transition-colors ${
                    role === "employee" ? "text-blue-700" : "text-slate-500 hover:text-slate-700"
                  }`}
                >
                  Employee
                </button>
                <button
                  ...
                  onClick={() => setRole("hr")}
                  className={`relative z-10 flex-1 py-2 text-sm font-semibold rounded-lg transition-colors ${
                    role === "hr" ? "text-blue-700" : "text-slate-500 hover:text-slate-700"
                  }`}
                >
                  HR / Recruiter
                </button>
