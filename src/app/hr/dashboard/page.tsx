        ...
        <div className="relative rounded-[2rem] bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 p-8 md:p-10 text-white overflow-hidden shadow-[0_20px_40px_-15px_rgba(0,0,0,0.25)] border border-white/[0.07]">
          ...
          <div className="relative">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                href="/hr/jobs/new"
                className="inline-flex items-center gap-1.5 rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-blue-700 shadow-sm transition-all hover:bg-blue-50 hover:shadow-md"
              >
        ...
        <div className="rounded-2xl border border-white/60 bg-white/60 backdrop-blur-xl shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] overflow-hidden">
          ...
          {recentJobs.length === 0 ? (
            <div className="px-5 py-12 text-center">
              ...
              <p className="mt-1 text-xs text-slate-400">
                Post your first job description to start matching candidates
              </p>
              <Link
                href="/hr/jobs/new"
                className="mt-4 inline-flex items-center gap-1 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-xs font-semibold text-blue-700 hover:bg-blue-100 transition-colors"
              >
                + Create job
              </Link>
            </div>
