      ...
      {jobList.length > 0 && (
        <div className="space-y-3">
          {jobList.map((job) => (
            <div
              key={job.id}
              className="rounded-lg border border-gray-200 bg-white p-5 flex items-center justify-between"
            >
              ...
              {job.status === "ready" && (
                <Link
                  ...
                  className="flex-shrink-0 rounded-md border border-blue-200 bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-700 hover:bg-blue-100"
                >
                  View Candidates
                </Link>
              )}
