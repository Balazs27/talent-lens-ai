...
export default async function EmployeeDashboard() {
  ...
  return (
    <div className="max-w-5xl space-y-8">
        ...
        <div className="relative rounded-[2rem] bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 p-8 md:p-10 text-white overflow-hidden shadow-[0_20px_40px_-15px_rgba(0,0,0,0.25)] border border-white/[0.07]">
          ...
          <div className="relative">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                href="/employee/resume"
                className="btn-shimmer inline-flex items-center rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-blue-600 shadow-sm transition-all hover:bg-blue-50 hover:shadow-md active:scale-[0.98]"
              >
                {latestResume ? "Update Resume" : "Upload Resume"}
              </Link>
              <Link
                href="/employee/matches"
                className="inline-flex items-center rounded-lg bg-white/10 px-4 py-2.5 text-sm font-medium text-white border border-white/20 transition-all hover:bg-white/20 active:scale-[0.98]"
              >
                View Matches
              </Link>
            </div>
      ...
      {/* ── Onboarding / Next Steps (context-aware) ── */}
      <section
        className="animate-[fadeUp_0.5s_ease-out_both]"
        style={{ animationDelay: "200ms" }}
      >
        {!latestResume ? (
          /* ── Getting Started checklist (new user) ── */
            ...
            <div className="divide-y divide-slate-100">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-blue-500/80">Start here — enables all matching features</p>
                </div>
              ...
              <div className="px-5 py-4 flex items-center gap-4 opacity-40 select-none">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-slate-600">Browse job matches</p>
                  <p className="text-xs text-slate-400">Unlocks after resume upload</p>
                </div>
              ...
              <div className="px-5 py-4 flex items-center gap-4 opacity-40 select-none">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-slate-600">Analyze skill gaps</p>
                  <p className="text-xs text-slate-400">Unlocks after getting matches</p>
                </div>
                <svg className="w-3.5 h-3.5 text-slate-300 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                </svg>
          ...
          /* ── Regular next steps (returning user) ── */
          <div className="rounded-2xl border border-white/60 bg-white/60 backdrop-blur-xl shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] overflow-hidden">
            <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
              <h2 className="text-base font-bold tracking-tight text-slate-900">
                Next Steps
            ...
            <div className="divide-y divide-slate-100">
              {nextSteps.filter((s) => s.href !== "/employee/resume").map((step) => (
                <Link
                  key={step.href}
                  href={step.href}
